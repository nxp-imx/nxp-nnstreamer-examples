...
MODEL_LATENCY_CPU_NS[IMX8MP]="${LATENCY_CPU:-60000000}"
MODEL_LATENCY_CPU_NS[IMX93]="${LATENCY_CPU:-75000000}"
MODEL_LATENCY_CPU_NS[IMX95]="${LATENCY_CPU:-40000000}"
MODEL_LATENCY_CPU_NS[IMX952]="${LATENCY_CPU:-40000000}"

declare -A MODEL_LATENCY_GPU_NS
MODEL_LATENCY_GPU_NS[IMX8MP]="${LATENCY_GPU:-500000000}"

declare -A MODEL_LATENCY_NPU_NS
MODEL_LATENCY_NPU_NS[IMX8MP]="${LATENCY_NPU:-40000000}"
MODEL_LATENCY_NPU_NS[IMX93]="${LATENCY_NPU:-10000000}"
MODEL_LATENCY_NPU_NS[IMX95]="${LATENCY_NPU:-25000000}"
MODEL_LATENCY_NPU_NS[IMX952]="${LATENCY_NPU:-25000000}"
