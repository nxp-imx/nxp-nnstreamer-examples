...
Type `1.16.0` on the Downloads search bar and select the eIQ Toolkit 1.16.0 Installer for Ubuntu.
...
chmod a+x ~/Downloads/eiq-toolkit-v1.16.0.<...>.deb.bin
sudo ~/Downloads/eiq-toolkit-v1.16.0.<...>.deb.bin
```
...
export EIQ_BASE="/opt/nxp/eIQ_Toolkit_v1.16.0"
